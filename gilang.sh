...
echo $green"kontak admin:xxxxxx5961"
echo $Orange"Autohor:gilang-saputra"
echo $Red"Thanks To all"
echo             "
...
then
clear
echo $green"gilang-saputra"
echo $green"Jika Ada masalah Hubungi Nomer Saya "
echo $green"kontak admin:62821-3050-5651"
echo $green"ThanksTo;allah swt"
echo $green"ThanksTo;nabi muhammad saw"
echo $green"ThanksTo;gilang"
echo $green"ThanksTo;all"
echo $red"no_sytem_is_safe"
exit 
fi
